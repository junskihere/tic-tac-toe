...
import GamesHistoryComponent from './game-history';
...
const SettingsComponent = () => {
  ...
  return <>
    {
      showGameHistory && <GamesHistoryComponent setShowGameHistory={setShowGameHistory} />
    }
    <div className={styles.container}>
      ...
      <br />
      <div>
        <button type="button" className="nes-btn" onClick={() => setShowGameHistory(true)}>Game History</button>
      </div>
      <br />
